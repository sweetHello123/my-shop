...
<div id="header">
    <div class="header-box">
        ...
        <ul class="header-right">
            ...
            <c:if test="${session_user!=null}">
                <li class="denglu">Hi~<a class="red">${session_user.username}</a> <a href="/logout">[注销]</a></li>
            </c:if>
            <li class="shu"></li>
...
<div id="lunbo">
    <ul id="one">
        <c:forEach items="${ppt}" var="ppt">
            <li><a href=""><img src="${ppt.picture}" alt="${ppt.title}" title="${ppt.title}"></a></li>
        </c:forEach>
            ...
            <div class="picScroll_left">
                ...
                <div class="bd">
                    <ul class="picList">
                        <li>
                            <div class="pic">
                                <a href="#" target="_blank"><img src="../../static/images/rem_shangp.jpg"/></a>
                            </div>
                            <div class="title">
                                <a href="#" target="_blank">佳能(Canon)EOS80D单反套机</a><span>¥ 506 .00</span>
                            </div>
                        </li>
                        <li>
                            <div class="pic"><a href="#" target="_blank">
                                <img src="../../static/images/rem_shangp1.jpg"/></a>
                            </div>
                            <div class="title">
                                <a href="#" target="_blank">佳能(Canon)EOS80D单反套机</a><span>¥ 7940 .00</span>
                            </div>
                        </li>
                        <li>
                            <div class="pic">
                        ...
                        <li>
                            <div class="pic">
                                <a href="#" target="_blank"><img src="../../static/images/rem_shangp1.jpg"/></a>
                            </div>
                            <div class="title">
                                <a href="#" target="_blank">佳能(Canon)EOS80D单反套机</a><span>¥ 7940 .00</span>
                            </div>
