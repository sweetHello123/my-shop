            ...
            <div class="kengl_kuang">
                <form action="/login" method="post">
                    <div class="txt_kuang">
                        ...
                        <input id="password" name="password" type="text" class="itxt" placeholder="密码">
                        <div>
                            <input style="width: 120px;height: 30px;" id="vfCode" name="vfCode" type="text" class="itxt" placeholder="验证码">
                            <img id="img_vfCode" src="/vfCode" style="cursor: pointer;margin-left: 20px" title="看不清? 换一张"/>
                        </div>
                    </div>
                    <div class="remember">
                        <div class="fl">
...
<script>
    $(function () {
        // 刷新验证码
        $("#img_vfCode").bind("click", function () {
            $(this).hide().attr('src', '/vfCode?random=' + Math.random()).fadeIn();
        });
    });
</script>
</body>
