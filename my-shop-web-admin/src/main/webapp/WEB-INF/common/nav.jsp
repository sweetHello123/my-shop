...
<header class="main-header">
    ...
    <!-- 头导航栏: style can be found in header.less -->
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            <ul class="menu">
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/static/dist/img/admin.jpg" class="img-circle"
                                                 alt="User Image">
                                        </div>
                                        <h4>
                                            Support Team
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/static/img/admin.jpg" class="user-image" alt="User Image">
                        <span class="hidden-xs">${session_user.email}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
